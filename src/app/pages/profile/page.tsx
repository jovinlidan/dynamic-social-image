  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Check out the GitHub profile of ${username}`} />
        <meta property="og:title" content={`GitHub Profile of ${username}`} />
        <meta property="og:description" content={`Dynamically generated profile image for ${username}`} />
        <meta property="og:image" content={ogImageUrl} />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`GitHub Profile of ${username}`} />
        <meta name="twitter:description" content={`Dynamically generated profile image for ${username}`} />
